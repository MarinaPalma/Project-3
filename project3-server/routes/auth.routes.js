  ...
  User.findOne({ email })
    .then((user) => {
      ...
      bcrypt.compare(password, user.password).then((isSamePassword) => {
        ...
        const { _id, email, city, imageProfile, name} = user; //POR AQUI O QUE QUERO QUE APAREÇA NO PERFIL

        const payload = { _id, email, city, imageProfile, name};//POR AQUI O QUE QUERO QUE APAREÇA NO PERFIL
