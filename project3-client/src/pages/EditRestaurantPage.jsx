...
function EditRestaurantPage() {
  ...
  const handleSubmit = async (event) => {
    try {
        ...
        const getToken = localStorage.getItem("authToken");
        await axios.put( `${process.env.REACT_APP_BASE_API_URL}/restaurants/${restaurantId}`, editRestaurant,
        {
          headers: {
            Authorization: `Bearer ${getToken}`,
          },
  ...
  return (
    ...
    <form onSubmit= {handleSubmit} >
            ...
            {/* <label>Reviews</label>
            <input type="number" name="comments" value={comments} onChange={ handleComments } /> */}
{/* 
            <label></label>
